...
- format final WebP en 1600 x 900 ;
- compression entre 95 Ko et 179 Ko ;
- profil couleur sRGB ;
- métadonnées EXIF présentes ;
- nom de fichier descriptif ;
- alt text naturel dans les données ville ;
- coordonnées EXIF utilisées comme lieu représenté, pas comme preuve de prise de vue appareil.

| Ville | Fichier | Taille |
| --- | --- | ---: |
| Nice | `/images/local-heroes/seo-local-nice-promenade-des-anglais.webp` | 145 Ko |
| Cannes | `/images/local-heroes/consultant-seo-cannes-croisette-palais.webp` | 100 Ko |
| Antibes | `/images/local-heroes/consultant-seo-antibes-port-vauban.webp` | 176 Ko |
