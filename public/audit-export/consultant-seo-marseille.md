# Audit SEO : /consultant-seo-marseille

## Informations de base

- **URL** : https://indhack.com/consultant-seo-marseille
- **Title** : Consultante SEO Marseille | Indiana Aflalo - Experte Référencement
- **Meta Description** : Consultante SEO à Marseille : boostez votre visibilité Google. Experte en référencement local pour PME et entrepreneurs des Bouches-du-Rhône. Audit gratuit ✆ 06 61 13 97 48
- **H1** : Consultante SEO Marseille | Indiana Aflalo - Experte Référencement
- **Nombre de mots** : 1500

## Structure des titres

- **H2** : 
                            Zones d'intervention à Marseille et alentours
...
```
Page locale pour Marseille. Cette page utilise le template CityPageTemplateV2 et contient:
- Hero avec titre "Consultant SEO Marseille"
...
| Lien template | /seo-local |
| Audit technique SEO | /consultant-seo-marseille/audit-technique |
