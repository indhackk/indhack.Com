# Audit SEO : /consultant-seo-bordeaux

## Informations de base

- **URL** : https://indhack.com/consultant-seo-bordeaux
- **Title** : Consultant SEO Bordeaux
- **Meta Description** : Boostez votre visibilité sur Google à ${cityData.name}. Consultante SEO freelance experte en référencement local pour PME et entrepreneurs de ${cityData.department}. Audit gratuit ✆ 06 61 13 97 48
- **H1** : Consultant SEO Bordeaux
- **Nombre de mots** : 1500

## Structure des titres

- **H2** : 
                            Zones d'intervention à Bordeaux et alentours
...
```
Page locale pour Bordeaux. Cette page utilise le template CityPageTemplateV2 et contient:
- Hero avec titre "Consultant SEO Bordeaux"
...
| Lien template | /seo-local |
| Audit technique SEO | /consultant-seo-bordeaux/audit-technique |
