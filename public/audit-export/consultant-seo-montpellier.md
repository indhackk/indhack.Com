# Audit SEO : /consultant-seo-montpellier
...
- **Meta Description** : Consultante SEO à Montpellier : boostez votre visibilité Google. Experte en référencement local pour PME et startups de l
- **H1** : Consultante SEO Montpellier | Indiana Aflalo - Experte Référencement
- **Nombre de mots** : 1500

## Structure des titres

- **H2** : 
                            Zones d'intervention à Montpellier et alentours
...
```
Page locale pour Montpellier. Cette page utilise le template CityPageTemplateV2 et contient:
- Hero avec titre "Consultant SEO Montpellier"
...
| Lien template | /seo-local |
| Audit technique SEO | /consultant-seo-montpellier/audit-technique |
