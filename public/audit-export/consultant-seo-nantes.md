# Audit SEO : /consultant-seo-nantes
...
- **H1** : Consultant SEO Nantes
- **Nombre de mots** : 1500

## Structure des titres

- **H2** : 
                            Zones d'intervention à Nantes et alentours
...
```
Page locale pour Nantes. Cette page utilise le template CityPageTemplateV2 et contient:
- Hero avec titre "Consultant SEO Nantes"
...
| Lien template | /seo-local |
| Audit technique SEO | /consultant-seo-nantes/audit-technique |
