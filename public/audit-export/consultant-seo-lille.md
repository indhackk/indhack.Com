# Audit SEO : /consultant-seo-lille

## Informations de base

- **URL** : https://indhack.com/consultant-seo-lille
- **Title** : Consultant SEO Lille
- **Meta Description** : Boostez votre visibilité sur Google à ${cityData.name}. Consultante SEO freelance experte en référencement local pour PME et entrepreneurs du ${cityData.department}. Audit gratuit ✆ 06 61 13 97 48
...
- **H2** : 
                            Zones d'intervention à Lille et alentours
...
```
Page locale pour Lille. Cette page utilise le template CityPageTemplateV2 et contient:
- Hero avec titre "Consultant SEO Lille"
...
| Lien template | /seo-local |
| Audit technique SEO | /consultant-seo-lille/audit-technique |
