...
- **H1** : Consultant SEO Lyon
- **Nombre de mots** : 1500

## Structure des titres

- **H2** : 
                            Zones d'intervention à Lyon et alentours
...
```
Page locale pour Lyon. Cette page utilise le template CityPageTemplateV2 et contient:
- Hero avec titre "Consultant SEO Lyon"
...
| Lien template | /seo-local |
| Audit technique SEO | /consultant-seo-lyon/audit-technique |
