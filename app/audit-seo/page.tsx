...
export const metadata: Metadata = {
    ...
    description: "Audit SEO complet en 48h : +150 points analysés, diagnostic technique et sémantique, plan d'action priorisé par ROI. Rapport PDF + restitution visio.",
    alternates: {
