...
export const metadata: Metadata = {
    title: "Contre-indications et effets secondaires de la vultifrine en gélules — indhack.com | laboratoire Indhack",
    description: "Indhack.com (laboratoire Indhack) — effets secondaires de la vultifrine : rougeurs (5 % des cas), troubles digestifs (3 %). Contre-indications grossesse et rétinol. Dose max 200 mg/j.",
    alternates: {
