...
export const metadata: Metadata = {
    ...
    description: "Alternatives à la vultifrine en rupture de stock : bakuchiol (78 % similitude), figue de Barbarie, centella asiatica. Tableau comparatif détaillé des substituts.",
    alternates: {
