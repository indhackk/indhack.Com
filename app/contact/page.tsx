...
import { Phone, Mail, MapPin, Send, Linkedin, CheckCircle2 } from "lucide-react";
                ...
                <div className="container mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-white/70 max-w-2xl mx-auto">
                            Un projet de <strong>référencement naturel</strong> ou de <strong>création de site</strong> ?
                            Échangeons pour voir comment je peux vous accompagner.
                        </p>
                    </motion.div>
                </div>
            </section>
                            ...
                            {isSubmitted ? (
                                <div className="bg-white p-10 rounded-2xl border border-gray-100 shadow-sm text-center">
                                    ...
                                    <p className="text-soft mb-6">
                                        Votre client mail s'est ouvert. Je vous réponds sous 24h.
                                    </p>
                                ...
                                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-5">
                                    <div>
                                        ...
                                        <p className="text-soft text-sm">Remplissez ce formulaire pour me contacter.</p>
                                    </div>
