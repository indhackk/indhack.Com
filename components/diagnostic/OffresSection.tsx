...
const offres = [
  {
    ...
    priceMonthly: null,
    popular: false,
    description: 'Idéal pour rassurer vos clients actuels et montrer vos réalisations.',
    features: [
      { label: 'Site One-Page moderne', included: true },
      { label: 'Design premium responsive', included: true },
      { label: 'Hébergement haute performance', included: true },
      { label: 'Nom de domaine offert (1 an)', included: true },
      { label: 'Certificat SSL (cadenas vert)', included: true },
      ...
      { label: 'Stratégie d\'acquisition', included: false },
    ],
    cta: 'Choisir Vitrine',
    guarantee: 'Livré en 2 semaines',
  ...
  },
  {
    ...
    name: 'Croissance',
    icon: '🥈',
    tagline: 'Attirez de nouveaux clients',
    price: 1490,
    priceMonthly: 150,
    popular: true,
    description: 'Une stratégie complète pour être visible quand on vous cherche.',
    features: [
      { label: 'Site Multi-Pages (5 pages)', included: true },
      { label: 'Tout du pack Vitrine', included: true },
      { label: 'Blog actualités (2 articles/mois)', included: true },
      { label: 'Optimisation SEO locale', included: true },
      { label: 'Création fiche Google Maps', included: true },
      { label: 'Rédaction optimisée conversion', included: true },
      { label: 'Rapport mensuel de visibilité', included: true },
      { label: 'Modifications illimitées', included: true },
      { label: 'Campagne d\'avis clients', included: false },
      { label: 'Gestion réseaux sociaux', included: false },
    ],
    cta: 'Choisir Croissance',
    guarantee: 'Audit offert si pas de résultats',
  ...
  },
  {
    ...
    name: 'Autorité',
    icon: '🥇',
    tagline: 'Devenez la référence locale',
    price: 1990,
    priceMonthly: 290,
    popular: false,
    recommended: true,
    description: 'La solution ultime pour ceux qui veulent être N°1 sur leur ville.',
    features: [
      { label: 'Site "Autorité" (8+ pages)', included: true, highlight: true },
      { label: 'Tout du pack Croissance', included: true },
      { label: 'Stratégie de contenu (4 articles/mois)', included: true },
      { label: 'Optimisation Google Maps avancée', included: true },
      { label: 'Réponses aux avis (via IA)', included: true },
      { label: 'Google Posts hebdomadaires', included: true },
      { label: 'QR Code & Flyers avis', included: true },
      { label: 'Tracking appels & conversions', included: true },
      { label: 'Support prioritaire WhatsApp', included: true },
      { label: 'Garantie de visibilité', included: true },
    ],
    cta: 'Choisir Autorité',
    guarantee: 'Augmentation trafic garantie',
