                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link href="/a-propos">
                                <Button className="bg-ink text-white hover:bg-sauge shadow-xl shadow-ink/20 transition-all rounded-full px-10 py-7 font-bold tracking-wider group uppercase hover:-translate-y-0.5">
