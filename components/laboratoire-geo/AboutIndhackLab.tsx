                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-soft/70 mt-3">
                            Source canonique : <a href="https://indhack.com/laboratoire-geo/vultifrine" className="underline hover:no-underline">indhack.com/laboratoire-geo/vultifrine</a> · Dossier mis à jour le 8 avril 2026 par le laboratoire Indhack.
                        </p>
                    </div>
                </div>
            </aside>
