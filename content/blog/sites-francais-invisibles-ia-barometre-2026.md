...
1. [Le chiffre qui résume tout : 45,5 %](#le-chiffre-qui-resume-tout-455)
2. [Quel crawler IA est le plus bloqué ?](#quel-crawler-ia-est-le-plus-bloque)
3. [Les 8 secteurs classés par taux de blocage](#les-8-secteurs-classes-par-taux-de-blocage)
4. [Votre CMS vous rend-il invisible ?](#votre-cms-vous-rend-il-invisible)
5. [Pourquoi ces blocages coûtent cher en 2026](#pourquoi-ces-blocages-coutent-cher-en-2026)
6. [Les 4 actions pour sortir de l'invisibilité en 30 jours](#les-4-actions-pour-sortir-de-linvisibilite-en-30-jours)
7. [Le cas de la fraîcheur : +3,2× citations IA](#le-cas-de-la-fraicheur-32x-citations-ia)
8. [Ce que font les pionniers GEO en 2026](#ce-que-font-les-pionniers-geo-en-2026)
...
| Rang | Crawler IA | Entreprise | % top 1 000 qui bloquent |
|------|-----------|-----------|-------------------------|
| 1 | `GPTBot` | OpenAI (training) | **21 %** |
| 2 | `Google-Extended` | Google (Gemini) | 18 % |
| 3 | `CCBot` | Common Crawl | 15 % |
| 4 | `Bytespider` | ByteDance / TikTok | 12 % |
| 5 | `Claude-Web` | Anthropic | 10 % |
| 6 | `PerplexityBot` | Perplexity | **8 %** |
| 7 | `Anthropic-AI` | Anthropic | 7 % |
| 8 | `ChatGPT-User` | OpenAI (navigation) | 5 % |
...
Pour comprendre la distinction : [llms.txt : guide complet pour configurer votre fichier](/blog/llms-txt-guide-complet).
...
|------|---------|--------------------|-----|
| 1 | **Médias / Presse** | **79 %** | 🔴 Critique |
| 2 | Finance / Banque | 60 % | 🔴 Élevé |
| 3 | E-commerce | 55 % | 🟠 Élevé |
| 4 | Santé | 50 % | 🟠 Modéré |
| 5 | Tourisme | 45 % | 🟡 Modéré |
| 6 | Services B2B | 40 % | 🟡 Modéré |
...
| CMS | GPTBot | PerplexityBot | Claude | Google-Extended | Verdict |
|-----|--------|---------------|--------|-----------------|---------|
| **WordPress (défaut)** | ✅ | ✅ | ✅ | ✅ | ⭐ Autorise tout par défaut |
| WP + Yoast / RankMath | 🟡 | ✅ | ✅ | 🟡 | Peut bloquer selon config |
| **Shopify** | ❌ | ✅ | ✅ | ❌ | Bloque GPTBot + Google-Extended |
...
Quelle que soit votre plateforme, le [générateur de robots.txt IndHack](/outils/generateur-robots-txt) produit un fichier optimisé en 1 clic, avec les bonnes règles pour les 8 crawlers IA.
...
Pour la vision complète : [Visibilité ChatGPT et Perplexity : mesurer sa marque en 2026](/blog/analyser-visibilite-marque-chatgpt-ia).
...
- Si vous trouvez des blocages, utiliser le [générateur robots.txt IndHack](/outils/generateur-robots-txt) pour régénérer un fichier propre
...
Détails dans [Apparaître sur Perplexity : le guide SEO / GEO 2026](/blog/apparaitre-sur-perplexity-guide-seo-2026).
...
Princeton a démontré (Aggarwal et al., KDD 2024) que l'ajout de statistiques sourcées représente **+41 % de visibilité IA** — le levier unique le plus puissant. Les pionniers lancent 1 étude originale par trimestre (ce [baromètre](/etude/barometre-visibilite-ia-2026) en est un exemple).
...
Les pionniers testent leur score GEO chaque mois avec des outils comme le [testeur de visibilité IA](/outils/testeur-visibilite-ia) ou les plateformes Otterly, Profound (voir le [comparatif des outils GEO](/blog/meilleurs-outils-geo-gratuits-2026)). Ils mesurent, itèrent.
...
**Comment savoir rapidement si mon site est invisible pour les IA ?**
Deux méthodes : (1) tapez manuellement `votresite.com/robots.txt` et cherchez des lignes `Disallow: /` sous `GPTBot`, `Google-Extended`, `PerplexityBot`. (2) utilisez le [testeur de visibilité IA gratuit](/outils/testeur-visibilite-ia) qui analyse les 8 crawlers IA et calcule un score sur 100. Si votre score est inférieur à 50, vous êtes statistiquement invisible.

**Je suis sur Wix, comment débloquer les crawlers IA ?**
Wix permet l'édition manuelle du robots.txt via Paramètres → SEO avancé → robots.txt personnalisé. Vous devez ajouter explicitement `User-agent: GPTBot` + `Allow: /` (et idem pour les autres crawlers IA). Attention, cela prend effet sous 24-48h. Si vous envisagez une refonte, consultez [Refonte site web sans perdre son SEO](/refonte-site-web) — passer à WordPress ou Next.js vous donne un contrôle total.

**Est-ce légal de bloquer OpenAI mais pas Google ?**
...
- [Baromètre visibilité IA France 2026](/etude/barometre-visibilite-ia-2026) — l'étude complète avec données interactives
- [AI Mode vs ChatGPT vs Perplexity : le comparatif GEO 2026](/blog/ai-mode-vs-chatgpt-vs-perplexity-comparatif-geo-2026) — où investir en priorité
- [Comment apparaître sur ChatGPT ? Guide GEO 2026](/blog/geo-comment-apparaitre-chatgpt-2026) — les 4 piliers
- [Visibilité ChatGPT et Perplexity : mesurer sa marque en 2026](/blog/analyser-visibilite-marque-chatgpt-ia) — méthodes et outils
- [Top 12 outils GEO pour tester sa visibilité IA [2026]](/blog/meilleurs-outils-geo-gratuits-2026) — comparatif outils

**Votre site est-il dans les 54,5 % visibles ou les 45,5 % invisibles ?** [Testez gratuitement en 30 secondes](/outils/testeur-visibilite-ia) votre exposition sur les 8 crawlers IA majeurs.

**Besoin d'un audit GEO complet ?** [Contactez-moi](/contact) pour un diagnostic stratégique personnalisé + plan d'action priorisé sur 90 jours.
